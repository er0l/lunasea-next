...
class LunaProfile extends HiveObject {
  ...
  @JsonKey()
  @HiveField(46, defaultValue: 8080)
  int rtorrentPort;

  @JsonKey()
  @HiveField(47, defaultValue: '')
  String rtorrentUsername;

  @JsonKey()
  @HiveField(48, defaultValue: '')
  String rtorrentPassword;

  @JsonKey()
  @HiveField(49, defaultValue: <String, String>{})
  Map<String, String> rtorrentHeaders;
  ...
  LunaProfile._internal({
    ...
    //rTorrent
    required this.rtorrentEnabled,
    required this.rtorrentHost,
    required this.rtorrentPort,
    required this.rtorrentUsername,
    required this.rtorrentPassword,
    required this.rtorrentHeaders,
  });
  ...
  factory LunaProfile({
    ...
    return LunaProfile._internal(
      ...
      // rTorrent
      rtorrentEnabled: rtorrentEnabled ?? false,
      rtorrentHost: rtorrentHost ?? '',
      rtorrentPort: rtorrentPort ?? 8080,
      rtorrentUsername: rtorrentUsername ?? '',
      rtorrentPassword: rtorrentPassword ?? '',
      rtorrentHeaders: rtorrentHeaders ?? {},
    );
  }
