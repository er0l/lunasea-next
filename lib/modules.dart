...
import 'package:lunasea/modules/rtorrent/core/state.dart';
...
const MODULE_RTORRENT_KEY = 'rtorrent';
...
enum LunaModule {
  ...
  static LunaModule? fromKey(String? key) {
    switch (key) {
      ...
      case MODULE_RTORRENT_KEY:
        return LunaModule.RTORRENT;
...
extension LunaModuleEnablementExtension on LunaModule {
  ...
  bool get isEnabled {
    switch (this) {
      ...
      case LunaModule.RTORRENT:
        return LunaProfile.current.rtorrentEnabled;
      case LunaModule.WAKE_ON_LAN:
...
extension LunaModuleMetadataExtension on LunaModule {
  ...
  String? get website {
    switch (this) {
      ...
      case LunaModule.RTORRENT:
        return 'https://rakshasa.github.io/rtorrent/';
      case LunaModule.WAKE_ON_LAN:
        return null;
      case LunaModule.EXTERNAL_MODULES:
        return null;
  ...
  String? get github {
    switch (this) {
      ...
      case LunaModule.RTORRENT:
        return 'https://github.com/rakshasa/rtorrent';
      case LunaModule.WAKE_ON_LAN:
        return null;
      case LunaModule.EXTERNAL_MODULES:
        return null;
  ...
  String? get information {
    switch (this) {
      ...
      case LunaModule.RTORRENT:
        return 'rTorrent is a quick and efficient BitTorrent client that can be controlled via XML-RPC.';
      case LunaModule.WAKE_ON_LAN:
...
extension LunaModuleRoutingExtension on LunaModule {
  String? get homeRoute {
    switch (this) {
      ...
      case LunaModule.RTORRENT:
        return LunaRoutes.rtorrent.root.path;
      case LunaModule.WAKE_ON_LAN:
        return null;
      case LunaModule.EXTERNAL_MODULES:
  ...
  SettingsRoutes? get settingsRoute {
    switch (this) {
      ...
      case LunaModule.RTORRENT:
        return SettingsRoutes.CONFIGURATION_RTORRENT;
      case LunaModule.WAKE_ON_LAN:
...
extension LunaModuleExtension on LunaModule {
  ...
  LunaModuleState? state(BuildContext context) {
    switch (this) {
      ...
      case LunaModule.RTORRENT:
        return context.read<RTorrentState>();
      case LunaModule.EXTERNAL_MODULES:
        return null;
    }
  }
