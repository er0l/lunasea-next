...
import 'package:lunasea/modules/settings/routes/configuration_rtorrent/pages/connection_details.dart';
import 'package:lunasea/modules/settings/routes/configuration_rtorrent/route.dart';
...
enum SettingsRoutes with LunaRoutesMixin {
  ...
  CONFIGURATION_RTORRENT('rtorrent'),
  CONFIGURATION_RTORRENT_CONNECTION_DETAILS('connection_details'),
  ...
  GoRoute get routes {
    switch (this) {
      ...
      case SettingsRoutes.CONFIGURATION_RTORRENT:
        return route(widget: const ConfigurationRTorrentRoute());
      case SettingsRoutes.CONFIGURATION_RTORRENT_CONNECTION_DETAILS:
        return route(widget: const ConfigurationRTorrentConnectionDetailsRoute());
      ...
      case SettingsRoutes.CONFIGURATION_OVERSEERR_CONNECTION_DETAILS:
        return route(widget: const OverseerrConnectionDetailsPage());
    ...
    switch (this) {
      ...
      case SettingsRoutes.CONFIGURATION:
        return [
          ...
          SettingsRoutes.CONFIGURATION_RTORRENT.routes,
      ...
      case SettingsRoutes.CONFIGURATION_RTORRENT:
        return [
          SettingsRoutes.CONFIGURATION_RTORRENT_CONNECTION_DETAILS.routes,
        ];
      case SettingsRoutes.CONFIGURATION_OVERSEERR:
        return [
